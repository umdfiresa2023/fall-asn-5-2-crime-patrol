...
```{r}
Model3<- felm(total_violent_crime~treatment + Population + White + Blk_AfAm + Asian + Hisp_Lat + Housing + Occupied + Vacant + Shape__Are + TLML + PRECTOT + SPEED + treatment + total_violent_crime + total_property_crime | Name + month + dayofweek + year, data = panel)
summary(Model3)
```
